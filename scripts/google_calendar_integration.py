...
class GoogleCalendarIntegration:
    ...
    def search_meetings_for_company(
            ...
            try:
                ...
                for event in events:
                    ...
                    if (
                        ...
                        or company_name.lower() in description.lower()
                    ):
    ...
    def search_meetings_for_user(
        self, user_email: str, days_back: int = 90
    ) -> List[Dict]:
    ...
    def get_meeting_summary_for_company(
        self, company_name: str, days_back: int = 90
    ) -> Dict:
        ...
        for meeting in meetings:
            for attendee in meeting["attendees"]:
                if attendee:
                    attendees[attendee] = (
                        attendees.get(attendee, 0) + meeting["duration_minutes"]
                    )
...
def main():
    ...
    launchnodes_meetings = calendar.search_meetings_for_company(
    ...
    for email in team_emails:
        ...
        if user_meetings:
            ...
            print(
                f"  {email}: {len(user_meetings)} meetings, {total_duration} minutes total"
            )
