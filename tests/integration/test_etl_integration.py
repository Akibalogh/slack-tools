...
another-company,another-company::1220409a9fcc5ff6422e29ab978c22c004dde33202546b4bcbde24b25b85353366c2,another-company-channel,another-company,another-company.com,base,another-company"""
    ...
    def test_slack_database(self, temp_workspace):
        ...
        # Insert test data
        cursor.execute("INSERT INTO conversations (id, name, type) VALUES (1, 'test-company-channel', 'channel')")
        cursor.execute("INSERT INTO conversations (id, name, type) VALUES (2, 'another-company-channel', 'channel')")
        
        cursor.execute("INSERT INTO users (id, real_name, display_name) VALUES ('U123', 'Aki', 'Aki')")
        cursor.execute("INSERT INTO users (id, real_name, display_name) VALUES ('U456', 'Customer', 'Customer')")
        
        cursor.execute("INSERT INTO messages (id, conversation_id, author, text, timestamp) VALUES (1, 1, 'U123', 'Hello, how can we help?', 1640995200)")
        cursor.execute("INSERT INTO messages (id, conversation_id, author, text, timestamp) VALUES (2, 1, 'U456', 'We need help with integration', 1640995260)")
        cursor.execute("INSERT INTO messages (id, conversation_id, author, text, timestamp) VALUES (3, 2, 'U123', 'Thanks for the call', 1640995320)")
    ...
    def test_full_etl_workflow(self, temp_workspace, test_company_mapping, test_slack_database, test_telegram_data):
        ...
        etl.output_file = os.path.join(temp_workspace, 'output', 'notebooklm', 'etl_output.txt')
    ...
    def test_etl_output_format(self, temp_workspace, test_company_mapping, test_slack_database, test_telegram_data):
    ...
    def test_etl_quick_mode_vs_full_mode(self, temp_workspace, test_company_mapping, test_telegram_data):
