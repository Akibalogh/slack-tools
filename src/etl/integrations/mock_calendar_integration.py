...
class MockCalendarIntegration:
        ...
        while current_date <= end_date:
            ...
            for _ in range(num_meetings):
                ...
                meeting_time = current_date + timedelta(
                    hours=random.randint(9, 17), minutes=random.choice([0, 15, 30, 45])
                )
                ...
                meeting = {
                    ...
                    "end_time": (
                        meeting_time + timedelta(hours=random.randint(1, 3))
                    ).isoformat(),
                    ...
                    "created": (
                        meeting_time - timedelta(days=random.randint(1, 30))
                    ).isoformat(),
                    "updated": (
                        meeting_time - timedelta(days=random.randint(1, 7))
                    ).isoformat(),
    ...
    def _generate_attendees(self, company: str) -> List[Dict[str, str]]:
        ...
        internal_attendees = [
            {
                "email": "aki@bitsafe.com",
                "name": "Aki Balogh",
                "response_status": "accepted",
            },
            {
                "email": "sales@bitsafe.com",
                "name": "Sales Team",
                "response_status": "accepted",
            },
            {
                "email": "tech@bitsafe.com",
                "name": "Technical Team",
                "response_status": "tentative",
            },
            {
                "email": "product@bitsafe.com",
                "name": "Product Team",
                "response_status": "accepted",
            },
            {
                "email": "partnerships@bitsafe.com",
