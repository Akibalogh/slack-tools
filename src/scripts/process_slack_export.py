    ...
    def process_channels(self):
        ...
        for channel_info in channels_info:
            ...
            if channel_name.endswith("-bitsafe"):
                ...
                logger.debug(
                    f"Skipping channel {channel_name} (not a -bitsafe channel)"
                )
...
def main():
    ...
    parser.add_argument(
        "--export-path",
        default="data/raw/slack_export_20250815_064939",
        help="Path to Slack export directory",
    )
    parser.add_argument(
        "--db-path", default="data/slack/repsplit.db", help="Path to output database"
    )
