...
def analyze_sales_process():
    ...
    sales_patterns = {
        ...
        "9. Post-Sale Support": {
            "keywords": ["support", "help", "issue", "problem", "rewards distribution", "maintenance"],
    ...
    for stage_name, stage_info in sales_patterns.items():
        ...
        print(f"{stage_name:<30} | {count:>4} messages | {pattern_results[stage_name]['percentage']:>5.1f}%")
        print(f"  {description}")
        print()
    ...
    for conv_id, msg_count, first_msg, last_msg in top_conversations:
        ...
        print(f"  {channel_name:<25} | {msg_count:>3} messages | {duration_days:>5.1f} days")
