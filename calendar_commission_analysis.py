...
class CalendarCommissionAnalysis:
    ...
    def get_company_meeting_data(self, company_name: str, days_back: int = 180) -> dict:
        ...
        key_people_meetings = self._search_for_key_people_meetings(company_name, days_back)
        ...
        return {
            ...
            'total_company_meeting_time': sum(m['duration_minutes'] for m in all_meetings),
            'team_participation': self._calculate_team_participation(overlapping_meetings)
        }
    
    def _search_for_key_people_meetings(self, company_name: str, days_back: int = 180) -> list:
