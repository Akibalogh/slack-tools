...
class CRMTelegramMapper:
    ...
    def find_telegram_matches(self, companies: List[str]) -> Dict[str, str]:
        ...
        try:
            ...
            logger.info(f"Found {len(matches)} Telegram matches out of {len(companies)} companies")
            return matches
    ...
    def _find_chat_for_company(self, content: str, company_name: str) -> str:
        ...
        for link in soup.find_all('a'):
            ...
            if (company_lower in link_text or 
                any(word in link_text for word in company_lower.split()) or
                any(word in company_lower for word in link_text.split())):
    ...
    def generate_mapping_report(self, companies: List[str], matches: Dict[str, str]) -> str:
    ...
    def save_mapping_report(self, report: str, output_file: str = "crm_telegram_mapping.md"):
